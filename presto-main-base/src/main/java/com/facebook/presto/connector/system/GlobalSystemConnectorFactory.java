        ...
        implements ConnectorFactory
{
    ...
    {
        this(tables, procedures, tableFunctions, null);
    }

    @Inject
    public GlobalSystemConnectorFactory(Set<SystemTable> tables, Set<Procedure> procedures, Set<ConnectorTableFunction> tableFunctions, Changes changes)
    {
    ...
    {
        return new GlobalSystemConnector(catalogName, tables, procedures, tableFunctions, changes);
    }
}
